...
❌ **Testing implementation details** ❌ **Shared state between tests** ❌ **Not mocking external
dependencies** ❌ **Missing async/await** ❌ **Not testing error cases** ❌ **Slow tests** ❌ **Low
coverage** ❌ **Not running tests in CI**
