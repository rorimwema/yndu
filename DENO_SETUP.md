...
**Before:** `package.json` with npm
**After:** `deno.json` with import maps
...
### 3. Security Model
**Before:** Implicit access to everything
**After:** Explicit permissions required
...
### 4. Native TypeScript
**Before:** tsc compilation step
**After:** Direct TypeScript execution
...
### 5. Testing
**Before:** Jest/Vitest + configuration
**After:** Built-in test runner
